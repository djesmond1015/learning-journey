...
type CreateChaptersPageProps = {
  params: {
    courseId: string;
  };
};

const CreateChaptersPage: React.FC<CreateChaptersPageProps> = async ({
  params: { courseId },
}) => {
  ...
  return (
    <div className='flex flex-col items-start max-w-xl mx-auto my-16'>
      ...
      <div className='flex p-4 mt-5 border-none bg-secondary'>
        ...
        <div>
          We generated chapters for each of your units. Look over and then click
